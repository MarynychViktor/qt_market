...
QT_MOC_LITERAL(3, 16, 7), // "Worker*"
QT_MOC_LITERAL(4, 24, 6), // "worker"
QT_MOC_LITERAL(5, 31, 8), // "finished"
QT_MOC_LITERAL(6, 40, 4), // "quit"
QT_MOC_LITERAL(7, 45, 5), // "error"
QT_MOC_LITERAL(8, 51, 3), // "err"
QT_MOC_LITERAL(9, 55, 5) // "start"

    },
    "Worker\0started\0\0Worker*\0worker\0finished\0"
    "quit\0error\0err\0start"
};
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->started((*reinterpret_cast< Worker*(*)>(_a[1]))); break;
        case 1: _t->finished((*reinterpret_cast< Worker*(*)>(_a[1]))); break;
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Worker::quit)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void Worker::started(Worker * _t1)
{
...
// SIGNAL 1
void Worker::finished(Worker * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
